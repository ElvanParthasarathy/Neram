...
import com.elvan.neram.ui.calendar.EventPosition
import com.elvan.neram.ui.calendar.EventIndicatorStyle
...
fun CalendarScreen(
    ...
    val eventIndicators = remember(allEvents, currentMonth) {
        ...
        data class DailyEvent(val date: LocalDate, val event: com.elvan.neram.data.model.CalendarEvent)
    ...
    Column(
        modifier = Modifier
         ...
         CalendarMainLayout(
            ...
            viewType = if (calendarView == com.elvan.neram.ui.calendar.CalendarViewType.SCHEDULE) "schedule" else "month",
            onViewTypeChanged = { typeStr ->
                val newType = if (typeStr == "schedule") com.elvan.neram.ui.calendar.CalendarViewType.SCHEDULE else com.elvan.neram.ui.calendar.CalendarViewType.MONTH

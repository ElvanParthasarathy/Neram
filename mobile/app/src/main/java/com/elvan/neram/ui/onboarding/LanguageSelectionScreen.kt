...
fun LanguageSelectionScreen(
    ...
    AuthBackground {
        ...
        Column(
            ...
            // 4. Subtle Micro-Hint outside card (Option 1: Cleanest & Most Direct)
            // Whisper-thin text + chevron that smoothly fades out to 0% when the user scrolls down
            ...
            // 5. Continue Action Button - Positioned towards bottom with comfortable padding
            AnimatedAuthButton(
